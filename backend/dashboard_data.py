...
KNOWLEDGE_CLUSTERS = [
    {
        ...
        "topics": ["Forgetting Curve", "Spaced Repetition", "Active Recall"],
        "strength": 85,
        "lastReview": "2 days ago"
    },
    {
        ...
        "topics": ["Active Recall", "Spacing Effect", "Interleaved Practice"],
        "strength": 78,
        "lastReview": "4 days ago"
    },
    {
        ...
        "topics": ["Working Memory", "Metacognition", "Retrieval Practice"],
        "strength": 68,
        "lastReview": "1 week ago"
    }
]
...
# ========================================
# RECOMMENDATIONS (For Insights page)
# ========================================
RECOMMENDATIONS = [
    {
        "id": "rec1",
        "type": "review",
        "title": "Review: Working Memory",
    ...
    },
    {
        "id": "rec2",
        "type": "connection",
        "title": "Connect: Spacing Effect ↔ Interleaved Practice",
    ...
    },
    {
        "id": "rec3",
        "type": "practice",
        "title": "Practice: Active Recall Quiz",
        "description": "Your Active Recall knowledge is strong. Test yourself to maintain it.",
        "priority": "low",
        "action": "Take Quiz",
        "nodeId": "t2"
    }
